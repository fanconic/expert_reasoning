...
@dataclass
class IRLConfig(TrainingArguments):
    r"""
    Configuration class for the [`IRLTrainer`].

    This class includes only the parameters that are specific to Expert Reasoning Knowledge Distillation (IRL) training. 
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`IRLTrainer`] is provided as a string.
