...
ALGO_ORDER = [
    ...
    ('perturb_qwen3b_perturb_nearby_and_numbers', '+ Number swapping'),
...
def main():
    ...
    latex.append(r"}")
    latex.append(r"\caption{\textbf{Ablation on Reasoning Corruption} for Qwen2.5-3B (Step-wise) on GSM8K. All metrics are in percentages (\%). Intervals indicate 95\% confidence intervals.}")
    latex.append(r"\end{table}")

    output_file = os.path.join(ROOT_DIR, DATASET, "ablation_corruption_with_ci.txt")
