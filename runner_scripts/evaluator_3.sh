...
bash runner_scripts/${GPU_NUM}_run_gpu_node.sh irl_train.py --config-path=configs/medreason/${MODEL} --config-name=8B_1B_perturb_config_irl_train
bash runner_scripts/${GPU_NUM}_run_gpu_node.sh evaluate.py --config-path=configs/medreason/${MODEL} --config-name=8B_1B_perturb_config_eval
