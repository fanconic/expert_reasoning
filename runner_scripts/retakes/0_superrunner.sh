...
# run_sft_stack "medicine" "qwen4b"
# run_irl_variant "medicine" "qwen7b" "partial_fixed"
# run_irl_variant "medicine" "llama8b" "partial_fixed"
run_irl_variant "medicine" "llama8b" "full"
