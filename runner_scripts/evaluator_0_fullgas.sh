...
# ======== Bundles on GPU0 ========
run_bundle gsm8k_rebuttals     llama3b
run_bundle medreason_rebuttals llama8b
# =================================

bash runner_scripts/${GPU_NUM}_run_gpu_node.sh evaluate_pregenerated.py --config-path=configs/gsm8k_rebuttals/switch_reward --config-name=eval_qwen7b
