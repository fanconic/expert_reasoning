...
#  - gsm8k_rebuttals × llama8b
#  - medreason_rebuttals × llama8b
#
# Each bundle runs:
...
# ======== Bundles on GPU2 ========
run_bundle gsm8k_rebuttals     llama8b
run_bundle medreason_rebuttals llama3b
# =================================


bash runner_scripts/${GPU_NUM}_run_gpu_node.sh evaluate_pregenerated.py --config-path=configs/medreason_rebuttals/switch_reward --config-name=eval_qwen3b
bash runner_scripts/${GPU_NUM}_run_gpu_node.sh evaluate_pregenerated.py --config-path=configs/medreason_rebuttals/human_error --config-name=eval
