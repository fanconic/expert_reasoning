...
run_irl_variant() {
    ...
    local run_name="${model}_${dataset}_${suffix}" #"${model}_${dataset}_${suffix}"
    local wb_project="neurips_airl_${dataset}"
    local output_dir="/mnt/pdata/caf83/neurips2026/${dataset}/outputs/${run_name}"
...
# Balanced set for GPU 3.
# Keep qwen3b/llama3b at the end as requested.
run_combo "medicine" "qwen7b"
run_combo "math" "llama8b"
run_combo "mmlu" "qwen4b"
