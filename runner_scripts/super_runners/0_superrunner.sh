#!/usr/bin/env bash
# Super runner (GPU 0) - balanced workload chunk
set -u
...
run_combo "medicine" "qwen4b"
run_combo "math" "qwen7b"
# run_combo "mmlu" "qwen3b"
# run_combo "math" "llama3b"
